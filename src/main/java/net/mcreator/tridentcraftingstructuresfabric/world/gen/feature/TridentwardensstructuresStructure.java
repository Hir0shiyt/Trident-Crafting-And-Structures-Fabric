...
public class TridentwardensstructuresStructure {
			...
			if ((random.nextInt(1000000) + 1) <= 1000) {
				...
				for (int a = 0; a < count; a++) {
					...
					Structure structure = world.getStructureManager()
							.getStructureOrBlank(new Identifier("tridentcraftingstructuresfabric", "trident_wardens_structure_fabric"));
					if (structure == null)
						return false;
	...
	public static void init() {
		Registry.register(Registry.FEATURE, new Identifier("tridentcraftingstructuresfabric", "tridentwardensstructures"), feature);
		RegistryKey<ConfiguredFeature<?, ?>> configFeatKey = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier("tridentcraftingstructuresfabric", "tridentwardensstructures"));
