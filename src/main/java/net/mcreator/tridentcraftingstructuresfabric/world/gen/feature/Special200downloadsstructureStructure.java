...
public class Special200downloadsstructureStructure {
			...
			if ((random.nextInt(1000000) + 1) <= 5000) {
				...
				for (int a = 0; a < count; a++) {
					...
					Structure structure = world.getStructureManager()
							.getStructureOrBlank(new Identifier("tridentcraftingstructuresfabric", "200_downloads_special_structure"));
					if (structure == null)
						return false;
	...
	public static void init() {
		Registry.register(Registry.FEATURE, new Identifier("tridentcraftingstructuresfabric", "special_200downloadsstructure"), feature);
		RegistryKey<ConfiguredFeature<?, ?>> configFeatKey = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier("tridentcraftingstructuresfabric", "special_200downloadsstructure"));
