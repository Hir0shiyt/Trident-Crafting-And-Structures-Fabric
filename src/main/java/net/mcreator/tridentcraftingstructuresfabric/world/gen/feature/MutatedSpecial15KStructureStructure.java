...
public class MutatedSpecial15KStructureStructure {
			...
			if ((random.nextInt(1000000) + 1) <= 900) {
				...
				for (int a = 0; a < count; a++) {
					...
					Structure structure = world.getStructureManager()
							.getStructureOrBlank(new Identifier("tridentcraftingstructuresfabric", "15k_downloads_thanks_structure"));
					if (structure == null)
						return false;
	...
	public static void init() {
		Registry.register(Registry.FEATURE, new Identifier("tridentcraftingstructuresfabric", "mutated_special_15_k_structure"), feature);
		RegistryKey<ConfiguredFeature<?, ?>> configFeatKey = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier("tridentcraftingstructuresfabric", "mutated_special_15_k_structure"));
		...
		BiomeModifications.addFeature(
				...
				GenerationStep.Feature.UNDERGROUND_STRUCTURES, configFeatKey);
	}
}
