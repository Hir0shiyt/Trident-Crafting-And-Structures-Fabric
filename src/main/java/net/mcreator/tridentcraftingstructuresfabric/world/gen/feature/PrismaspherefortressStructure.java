...
public class PrismaspherefortressStructure {
			...
			if ((random.nextInt(1000000) + 1) <= 900) {
				...
				for (int a = 0; a < count; a++) {
					...
					Structure structure = world.getStructureManager()
							.getStructureOrBlank(new Identifier("tridentcraftingstructuresfabric", "prisma_sphere_fortress_fabric"));
					if (structure == null)
						return false;
	...
	public static void init() {
		Registry.register(Registry.FEATURE, new Identifier("tridentcraftingstructuresfabric", "prismaspherefortress"), feature);
		RegistryKey<ConfiguredFeature<?, ?>> configFeatKey = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier("tridentcraftingstructuresfabric", "prismaspherefortress"));
		...
		BiomeModifications.addFeature(BiomeSelectors.includeByKey(BiomeKeys.COLD_OCEAN, BiomeKeys.DEEP_COLD_OCEAN, BiomeKeys.DEEP_FROZEN_OCEAN,
				...
				BiomeKeys.OCEAN, BiomeKeys.WARM_OCEAN), GenerationStep.Feature.RAW_GENERATION, configFeatKey);
	}
}
