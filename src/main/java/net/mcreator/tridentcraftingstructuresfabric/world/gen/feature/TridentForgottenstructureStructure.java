...
public class TridentForgottenstructureStructure {
			...
			if ((random.nextInt(1000000) + 1) <= 5000) {
				...
				for (int a = 0; a < count; a++) {
					...
					Structure structure = world.getStructureManager()
							.getStructureOrBlank(new Identifier("tridentcraftingstructuresfabric", "trident_warden_structure"));
					if (structure == null)
						return false;
	...
	public static void init() {
		Registry.register(Registry.FEATURE, new Identifier("tridentcraftingstructuresfabric", "trident_forgottenstructure"), feature);
		RegistryKey<ConfiguredFeature<?, ?>> configFeatKey = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier("tridentcraftingstructuresfabric", "trident_forgottenstructure"));
