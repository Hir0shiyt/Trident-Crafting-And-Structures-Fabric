...
public class MutatedTridentForgottenStructureStructure {
			...
			if ((random.nextInt(1000000) + 1) <= 2000) {
				...
				for (int a = 0; a < count; a++) {
					...
					Structure structure = world.getStructureManager()
							.getStructureOrBlank(new Identifier("tridentcraftingstructuresfabric", "mutated_warden_structure"));
					if (structure == null)
						return false;
	...
	public static void init() {
		Registry.register(Registry.FEATURE, new Identifier("tridentcraftingstructuresfabric", "mutated_trident_forgotten_structure"), feature);
		RegistryKey<ConfiguredFeature<?, ?>> configFeatKey = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
				new Identifier("tridentcraftingstructuresfabric", "mutated_trident_forgotten_structure"));
		...
		BiomeModifications.addFeature(
				...
				GenerationStep.Feature.SURFACE_STRUCTURES, configFeatKey);
	}
}
